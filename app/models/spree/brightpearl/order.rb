module Spree
  module Brightpearl
    class Order < BaseConnection
      ...
      def set_rows
        @order_rows = @spree_order.line_items.map {|line_item| Spree::Brightpearl::OrderRow.new line_item}
      end
      ...
      def add_note
        Spree::Brightpearl::OrderNote.create @spree_order if @spree_order.note
      end
    end
  end
end
